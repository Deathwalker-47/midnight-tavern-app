    ...
    return (
      <div style={{ ...styles.screen, alignItems: "flex-start" }}>
        <div style={{ ...styles.card, width: 900 }}>
          ...
          <p style={styles.lede}>These choices become part of the sealed rulebook. Only basic gear and possessions described by the selected card or persona are forged now; the wider item catalog and future loot are generated by DM Rulings during play.</p>
          <StoryCreationReview
            persona={selectedPersona}
